...
LJLIB_ASM_(math_log10)		LJLIB_REC(math_call IRCALL_streflop_log10)
LJLIB_ASM_(math_exp)		LJLIB_REC(math_call IRCALL_streflop_exp)
LJLIB_ASM_(math_sin)		LJLIB_REC(math_call IRCALL_streflop_sin)
LJLIB_ASM_(math_cos)		LJLIB_REC(math_call IRCALL_streflop_cos)
LJLIB_ASM_(math_tan)		LJLIB_REC(math_call IRCALL_streflop_tan)
LJLIB_ASM_(math_asin)		LJLIB_REC(math_call IRCALL_streflop_asin)
LJLIB_ASM_(math_acos)		LJLIB_REC(math_call IRCALL_streflop_acos)
LJLIB_ASM_(math_atan)		LJLIB_REC(math_call IRCALL_streflop_atan)
LJLIB_ASM_(math_sinh)		LJLIB_REC(math_call IRCALL_streflop_sinh)
LJLIB_ASM_(math_cosh)		LJLIB_REC(math_call IRCALL_streflop_cosh)
LJLIB_ASM_(math_tanh)		LJLIB_REC(math_call IRCALL_streflop_tanh)
