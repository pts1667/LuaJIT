...
LJ_FUNC uint64_t LJ_FASTCALL lj_spring_prng_u64d(PRNGState *rs);
LJ_FUNC uint64_t LJ_FASTCALL lj_spring_prng_u64(PRNGState *rs);
LJ_FUNC void LJ_FASTCALL lj_spring_prng_seed_fixed(PRNGState *rs);
